            ...
            <div class="col-md-4 col-xl-4 d-flex justify-content-center justify-content-xl-start">
                <div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                    <div class="d-flex align-items-center p-3">
                        <div class="bs-icon-md bs-icon-circle bs-icon-primary shadow d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-instagram">
                        ...
                        <div class="px-2">
                            ...
                            <p class="text-muted mb-0"><a href="<?php echo($settings["instagram"]); ?>" style="text-decoration: none;"><?php echo($settings["instagram"]); ?></a></p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center p-3">
                        ...
                        <div class="px-2">
                            ...
                            <p class="text-muted mb-0"><a href="<?php echo($settings["github"]); ?>" style="text-decoration: none;"><?php echo($settings["github"]); ?></a></p>
                        </div>
                    </div>

                    <div class="d-flex align-items-center p-3">
                        <div class="bs-icon-md bs-icon-circle bs-icon-primary shadow d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-link-45deg">
                                <path d="M4.715 6.542 3.343 7.914a3 3 0 1 0 4.243 4.243l1.828-1.829A3 3 0 0 0 8.586 5.5L8 6.086a1.002 1.002 0 0 0-.154.199 2 2 0 0 1 .861 3.337L6.88 11.45a2 2 0 1 1-2.83-2.83l.793-.792a4.018 4.018 0 0 1-.128-1.287z"></path>
                                <path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.372-1.372a3 3 0 1 0-4.243-4.243L6.586 4.672z"></path>
                            </svg></div>
                        <div class="px-2">
                            <h6 class="fw-bold mb-0">Website</h6>
                            <p class="text-muted mb-0"><a href="<?php echo($settings["website"]); ?>" target="_blank" style="text-decoration: none;"><?php echo($settings["website"]); ?></a></p>
                        </div>
                    </div>
                </div>
            </div>
