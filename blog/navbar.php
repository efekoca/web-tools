...
<nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
    <div class="container">
        ...
        <button data-bs-toggle="collapse" class="navbar-toggler" data-target="#navcol-1" data-bs-target="#navcol-1"><span class="visually-hidden">Navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav mx-auto text-center">
                <li class="nav-item"><a class="nav-link active" href="index.php" data-bs-target="index.php">Home</a></li>
                <li class="nav-item"><a class="nav-link active" href="../">Tools</a></li>
