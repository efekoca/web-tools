...
?>
    ...
    <head>
        ...
        <title><?php echo($settings["title"]); ?> - Cookie Policy Settings</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div>
                <?php if(!empty($_POST["cookie"])){
                        $updateAboutUs = $connect->prepare("UPDATE settings SET cookie = ?, cookieUpdate = ?");
                        $updateAboutUs->execute(array(
                            javascriptFilter($_POST["cookie"]),
                            time(),
                        ));
                        ?>
                ...
                <div class="card shadow mb-3">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Cookie Policy</p>
                    </div>
                    <div class="card-body">
                        <form method="post">
                            <div class="row">
                                <div class="mb-3">
                                    <label class="form-label d-none" for="cookie"></label>
                                    <textarea id="cookie" class="ckeditor" name="cookie"><?php echo($settings["cookie"]); ?></textarea>
                                </div>
                            </div>
                            <div>
